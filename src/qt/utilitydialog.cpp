    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Essence Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Essence Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  essence-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Essence in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 ESS, 0.1 ESS, 1 ESS and 10 ESS -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://essencecoin.atlassian.net/wiki/display/DOC/PrivateSend\">https://essencecoin.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Essence Core is shutting down...") + "<br /><br />" +
