    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("ESS-light"), QVariant("light"));
    ui->theme->addItem(QString("ESS-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("ESS-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("ESS-traditional"), QVariant("trad"));
