    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Essence Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Essence address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and essence: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Essence Core"), this);
    aboutAction->setStatusTip(tr("Show information about Essence Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Essence Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Essence addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Essence addresses"));
    ...
    openAction->setStatusTip(tr("Open a essence: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Essence Core help message to get a list with possible Essence Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Essence Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Essence network", "", count));
}
...
{
    QString strTitle = tr("Essence Core"); // default title
