...
{
    if(fLiteMode) return; // ignore all Essence related functionality
...
/*
    ...
    allow endless transaction that would bloat Essence and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("essence-privatesend");
