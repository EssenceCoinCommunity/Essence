...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "EssenceNetwork") type = EssenceNetwork;
    if(strType == "EssenceNetworkVariable") type = EssenceNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == EssenceNetwork) s = "EssenceNetwork";
    if(type == EssenceNetworkVariable) s = "EssenceNetworkVariable";
