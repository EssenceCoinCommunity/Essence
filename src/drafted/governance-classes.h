 ...
 *
 *   // network
 *   CEssenceNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.essence.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CEssenceNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CEssenceNetwork(UniValue objIn)
    {
...
// // can be under: EssenceNetwork
// //   -- signature requirements : Key1(User)
// class CEssenceNetworkVariable : public CGovernanceObject
// {
// private:
