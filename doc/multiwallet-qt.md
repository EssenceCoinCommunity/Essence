...
Only requiring some minor changes is essence.cpp.
...
Changes to essence.cpp
----------------------
essence.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
