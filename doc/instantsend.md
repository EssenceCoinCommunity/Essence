...
This mechanism has been integrated into Bitcore-Node-Essence which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/essencecoin/insight-api-essence#web-socket-api](https://github.com/essencecoin/insight-api-essence#web-socket-api) 
* API: [https://github.com/essencecoin/insight-api-essence#instantsend-transactions](https://github.com/essencecoin/insight-api-essence#instantsend-transactions) 
...
By default, the Essence Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Essence Core daemon:
