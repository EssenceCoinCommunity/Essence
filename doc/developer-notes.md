...
Essence Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as Essence Core, where everyone uses
...
pay attention to for reviewers of Essence Core code.

General Essence Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Essence Core uses tinyformat, which is type safe. Leave them out to avoid confusion
