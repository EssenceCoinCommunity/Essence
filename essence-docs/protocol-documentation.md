...
This document describes the protocol extensions for all additional functionality build into the Essence protocol. This doesn't include any of the Bitcoin procotol, which has been left in tact in the Essence project. For more information about the core protocol, please see https://en.bitcoin.it/w/index.php?title#Protocol_documentation&action#edit
